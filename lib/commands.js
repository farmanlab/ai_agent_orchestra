...
function printHelp() {
  ...
  lines.push('  sync cursor          Sync to Cursor only');
  ...
  lines.push('  reverse cursor       Reverse sync from Cursor');
  ...
  lines.push('  --agents <list>      Comma-separated agents: claude,cursor,copilot');
  lines.push('');
