...
skills: [binding-figma-content-to-api, converting-figma-to-html]
model: sonnet
---

# Figma Content to API Binding Agent

Figma生成HTMLのコンテンツ要素をAPIレスポンスフィールドにバインディングし、データバインディング設計書を作成するエージェントです。
...
- **[binding-figma-content-to-api スキル](../skills/binding-figma-content-to-api/SKILL.md)**: 詳細なワークフロー
